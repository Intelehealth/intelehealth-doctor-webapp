...
@NgModule({
  ...
  imports: [
    ...
    NgxUiLoaderHttpModule.forRoot({
      showForeground: true,
      exclude: [
        'https://kf.intelehealth.org:3004/api/messages/',
        'https://kf.intelehealth.org:3004/api/support/',
        'https://kf.intelehealth.org:3004/api/auth/validateProviderAttribute',
      ]
    }),

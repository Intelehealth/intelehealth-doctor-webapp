...
const routes: Routes = [
  { path: "", component: FacilityConfigurationComponent },
];
...
@NgModule({
  declarations: [FacilityConfigurationComponent, AddFacilityDialogComponent],
  imports: [
  ...
  exports: [RouterModule, AddFacilityDialogComponent],
})

...
@Component({
  selector: 'app-vcto-hw',
  templateUrl: './vcto-hw.component.html',
  styleUrls: ['./vcto-hw.component.css']
})
export class VctoHwComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<VctoHwComponent>,

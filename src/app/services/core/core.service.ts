...
export class CoreService {
  ...
  openHelpMenuModal(): MatDialogRef<HelpMenuComponent> {
    const dialogRef = this.dialog.open(HelpMenuComponent, {
  ...
  openAddLicenseKeyModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(AddLicenseKeyComponent, {
      panelClass: "modal-md",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openUploadMindmapModal(): Observable<any> {
    const dialogRef = this.dialog.open(UploadMindmapJsonComponent, {
      panelClass: "modal-md",
      hasBackdrop: true,
      disableClose: true,
    });
  ...
  openNoInternetConnectionModal(): Observable<any> {
    const dialogRef = this.dialog.open(NoInternetComponent, {
      panelClass: "modal-md",
      hasBackdrop: true,
      disableClose: true,
    });
  ...
  openPasswordResetSuccessModal(): Observable<any> {
    const dialogRef = this.dialog.open(PasswordResetSuccessComponent, {
      panelClass: "modal-md",
      hasBackdrop: true,
      disableClose: true,
    });
  ...
  */
   ...
   * @return {Observable<any>} - Dialog result
   */
  openSharePrescriptionErrorModal(data: {
    msg: string;
    confirmBtnText: string;
  }): Observable<any> {
    const dialogRef = this.dialog.open(SharePrescriptionErrorComponent, {
      panelClass: "modal-md",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openVisitSummaryModal(data: { uuid: string }): Observable<any> {
    const dialogRef = this.dialog.open(ViewVisitSummaryComponent, {
      panelClass: "modal-lg",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openVideoCallOverlayModal(data: any): MatDialogRef<VcallOverlayComponent> {
    const dialogRef = this.dialog.open(VcallOverlayComponent, {
      panelClass: "modal-sm",
      data,
      id: "vcOverlayModal",
      disableClose: true,
  ...
  openSearchedPatientModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(SearchedPatientsComponent, {
      panelClass: "modal-lg",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openAppointmentDetailMonthViewModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(AppointmentDetailMonthComponent, {
      panelClass: ["modal-md", "dayView-con"],
      data,
      hasBackdrop: true,
      disableClose: true,
    });
  ...
  openConfirmCancelAppointmentModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(CancelAppointmentConfirmComponent, {
      panelClass: "modal-md",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openRescheduleAppointmentConfirmModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(
      ...
      { panelClass: "modal-md", data, hasBackdrop: true, disableClose: true }
    );
    return dialogRef.afterClosed();
  }
  ...
  openImagesPreviewModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(ImagesPreviewComponent, {
      panelClass: ["modal-lg", "transparent"],
      data,
      hasBackdrop: true,
      disableClose: true,
    });
  ...
  openConfirmDayOffModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(ConfirmDayOffComponent, {
      panelClass: "modal-md",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openConfirmHoursOffModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(ConfirmHoursOffComponent, {
      panelClass: "modal-md",
      data,
      hasBackdrop: true,
      disableClose: true,
  ...
  openConfirmOpenMrsIdModal(data: any): Observable<any> {
    const dialogRef = this.dialog.open(ConfirmOpenmrsIdComponent, {
      panelClass: "modal-md",
      data,
      disableClose: true,
    });
  ...
  openGenerateReportDialog(data: {
    ...
    const dialogRef = this.dialog.open(ReportGeneratorComponent, {
      panelClass: "modal-md",
      data,
    });
    return dialogRef.afterClosed();
  ...
  openReportSuccessDialog(): Observable<any> {
    const dialogRef = this.dialog.open(ReportSuccessComponent, {
      panelClass: "modal-md",
    });
    return dialogRef.afterClosed();
  }
   ...
   * @return {Observable<any>} - Dialog result
   */
  openLanguageFieldModal({
    data,
  }: {
    data: ILanguageFieldUpdate;
  }): MatDialogRef<LanguageFieldUpdate, any> {
    const dialogRef = this.dialog.open(LanguageFieldUpdate, {
      panelClass: "modal-lg",
      hasBackdrop: true,
      disableClose: false,
      data,
   ...
   * @return {Observable<any>} - Dialog result
   */
  openPlatformSelectionFieldModal({
    data,
  }: {
    data: { platform: string; lang_name: string };
  }): MatDialogRef<PlatformFieldsSelectonComponent, any> {
   ...
   * @return {Observable<any>} - Dialog result
   */
  openPatientVisitSubSectionModel({
    data,
  }: {
    data: any;
  }): MatDialogRef<SubSectionsComponent, any> {
    const dialogRef = this.dialog.open(SubSectionsComponent, {
      panelClass: "modal-md",
      hasBackdrop: true,
      disableClose: false,
      data,
   ...
   * @return {Observable<any>} - Dialog result
   */
  openPatientCallDurationHistoryModel({
    data,
  }: {
    data: any;
  }): MatDialogRef<CallHistoryComponent, any> {
   ...
   * @return {Observable<any>} - Dialog result
   */
  openPatientRegValidationsModal(
    data
  ): MatDialogRef<PatientRegValidationsComponent, any> {
    const dialogRef = this.dialog.open(PatientRegValidationsComponent, {
      panelClass: "modal-md",
      hasBackdrop: true,
      disableClose: true,
      data,

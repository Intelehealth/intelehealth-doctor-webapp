...
export class DiagnosisService {
  ...
  */
  getObs(patientId, conceptId): Observable<any> {
    ...
    const url = `${this.baseURL}/obs?patient=${patientId}&v=custom:(uuid,comment,value,encounter:(uuid,visit),groupMembers:(uuid,value,concept:(uuid,display)))&concept=${conceptId}`;
    return this.http.get(url);
  }
